...
import logo from "assets/images/logoo2.png.png"; // Path to your logo image
      ...
      >
        ...
        <SoftBox display="flex" alignItems="center">
          ...
          <SoftBox component={Link} to="/" py={transparent ? 1.5 : 0.75} lineHeight={1}>
            <SoftTypography variant="button" fontWeight="bold" fontSize="15px" color={light ? "white" : "dark"}>
              Synco Ambulances
            </SoftTypography>
          </SoftBox>
        </SoftBox>
